...
<?endif?>
<!-- Changes for Iframe issue -->
<form name="form_auth" method="post" target="_self" action="<?= str_replace("embed/",'',$arResult["AUTH_URL"])?>">
	<input type="hidden" name="AUTH_FORM" value="Y" />
	<input type="hidden" name="TYPE" value="AUTH" />
	<?if ($arResult["BACKURL"] <> ''):?>
	<input type="hidden" name="backurl" value="<?=str_replace("embed/",'',$arResult["BACKURL"])?>" />
	<?endif?>
	...
	<div class="">
		...
		<div class="login-item">
			...
			<input class="login-inp" type="password" name="USER_PASSWORD" placeholder="<?=GetMessage("AUTH_PASSWORD")?>" maxlength="255" autocomplete="new-password" value="<?=$arResult["LAST_PASSWORD"]?>" />
		</div>
		...
		<div class="login-text login-item">
			...
			<input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" checked/><label class="login-item-checkbox-label" for="USER_REMEMBER"><?=GetMessage("AUTH_REMEMBER_ME")?></label>
			<?endif?>
